...
public class CameraService extends Service implements //Takes photo using front camera in background of application
    ...
    private Camera openFrontFacingCameraGingerbread() { //Initialise camera
        if (mCamera != null) {
            mCamera.stopPreview();
            mCamera.release();
        }
    ...
    private void setBesttPictureResolution() { //Set resolution
    ...
    private boolean checkCameraHardware(Context context) { //Check camera
    ...
    private boolean checkFrontCamera(Context context) { //Check for front facing camera
        if (context.getPackageManager().hasSystemFeature(
    ...
    private class TakeImage extends AsyncTask<Intent, Void, Void> { //Take image
    ...
    Camera.PictureCallback mCall = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            File imagesFolder = new File(
                    Environment.getExternalStorageDirectory(), "MagazineUnlock");
